...
Use this page as the starting point for practical workflows around this module. diff in Luna-Flow/calculus-numerical.

## Suggested Flow

1. Read the repository README and the diff API reference.
2. Start from the constructors or entry points under `src/diff`.
