...
Use this page to explain the structural responsibilities and implementation constraints of this module. diff in Luna-Flow/calculus-numerical.

## Responsibilities

- Keep the code and docs aligned around `src/diff`.
