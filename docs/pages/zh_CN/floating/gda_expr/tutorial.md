...
仓库内 fixture 使用 `just smoke`；修复 Decimal 语义时使用定向的 `just pr phase=... --cases ...`；提交前运行完整 `just pr`。完整参数见[一致性测试数据](https://github.com/Luna-Flow/floating/blob/main/testdata/decimal/README.md)。
