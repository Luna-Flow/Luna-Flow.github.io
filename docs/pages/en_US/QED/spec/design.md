...
Use this page to explain the structural responsibilities and implementation constraints of this module. spec in Luna-Flow/QED.

## Responsibilities

- Keep the code and docs aligned around `doc/qed_formal_spec.typ`.
