...
Use this page to explain the structural responsibilities and implementation constraints of this module. prover in Luna-Flow/QED.

## Responsibilities

- Keep the code and docs aligned around `src/prover`.
