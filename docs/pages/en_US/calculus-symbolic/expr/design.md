...
Use this page to explain the structural responsibilities and implementation constraints of this module. expr in Luna-Flow/calculus-symbolic.

## Responsibilities

- Keep the code and docs aligned around `src/expr.mbt`.
