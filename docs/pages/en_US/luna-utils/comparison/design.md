...
Use this page to explain the structural responsibilities and implementation constraints of this module. comparison in Luna-Flow/luna-utils.

## Responsibilities

- Keep the code and docs aligned around `src/comparison.mbt`.
