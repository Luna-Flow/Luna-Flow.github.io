...
Use this page to explain the structural responsibilities and implementation constraints of this module. theory in Luna-Flow/stella.

## Responsibilities

- Keep the code and docs aligned around `doc/doc_en.typ`.
