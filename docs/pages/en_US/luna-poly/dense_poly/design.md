...
Use this page to explain the structural responsibilities and implementation constraints of this module. dense_poly in Luna-Flow/luna-poly.

## Responsibilities

- Keep the code and docs aligned around `src/dense_poly.mbt`.
