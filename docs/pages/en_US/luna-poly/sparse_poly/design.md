...
Use this page to explain the structural responsibilities and implementation constraints of this module. sparse_poly in Luna-Flow/luna-poly.

## Responsibilities

- Keep the code and docs aligned around `src/sparse_poly.mbt`.
