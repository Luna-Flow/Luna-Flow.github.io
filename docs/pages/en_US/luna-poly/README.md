...
- API Reference: [dense_poly](./dense_poly/api.md)
- API Reference: [dense_multi](./dense_multi/api.md)
- API Reference: [sparse_poly](./sparse_poly/api.md)
- API Reference: [exp_vec](./exp_vec/api.md)
