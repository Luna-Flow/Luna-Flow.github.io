...
追跡済み fixture には `just smoke`、Decimal 意味論の修正には `just pr phase=... --cases ...`、PR 前には完全な `just pr` を使います。詳細は[適合性データ手順](https://github.com/Luna-Flow/floating/blob/main/testdata/decimal/README.md)を参照してください。
