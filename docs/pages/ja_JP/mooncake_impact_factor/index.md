...
- API リファレンス: [score](/ja_JP/mooncake_impact_factor/score/api)
- API リファレンス: [cli](/ja_JP/mooncake_impact_factor/cli/api)
- API リファレンス: [static_search](/ja_JP/mooncake_impact_factor/static_search/api)
