...
Use this page to explain the structural responsibilities and implementation constraints of this module. quaternion in Luna-Flow/quaternion.

## Responsibilities

- Keep the code and docs aligned around `src/quaternion.mbt`.
