...
Use this page to explain the structural responsibilities and implementation constraints of this module. exp_vec in Luna-Flow/luna-poly.

## Responsibilities

- Keep the code and docs aligned around `src/exp_vec.mbt`.
