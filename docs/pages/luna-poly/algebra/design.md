...
Use this page to explain the structural responsibilities and implementation constraints of this module. algebra in Luna-Flow/luna-poly.

## Responsibilities

- Keep the code and docs aligned around `src/algebra.mbt`.
