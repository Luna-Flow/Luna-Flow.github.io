...
dense_multi is part of Luna-Flow/luna-poly. This page should describe the public types, constructors, functions, traits, and observable semantics that are implemented in the current branch.

## Scope

- Source boundary: `src/dense_multi.mbt`
